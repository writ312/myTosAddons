...
function MAPFOGVIEWER_ON_INIT(addon, frame)
	...
	acutil.setupHook(MAP_CHAR_UPDATE_HOOKED,"MAP_CHAR_UPDATE")
end
...
function MAP_CHAR_UPDATE_HOOKED(frame, msg, argStr, argNum)
	_G["MAP_CHAR_UPDATE_OLD"](frame, msg, argStr, argNum);
	DRAW_RED_FOG(frame);
end
