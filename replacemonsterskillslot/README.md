...
### SlotNumber
* SlotNumber allocated to the keyboard
...
### example
If you want to place it in QWER, type `/ rmss 11`

### コマンド
 `/rmss <SlotNumber>`

### SlotNumber
* SlotNumber はキーボードに割り振られている数値
    * aは1
    * qは11
    * 1は21 となっている
